...
public class TinOreFeature extends OreFeature {
	public static final TinOreFeature FEATURE = (TinOreFeature) new TinOreFeature().setRegistryName("avaritia_lp:tin_ore");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE
			.configured(new OreConfiguration(TinOreFeatureRuleTest.INSTANCE, AvaritiaLpModBlocks.TIN_ORE.defaultBlockState(), 30))
	...
	private static class TinOreFeatureRuleTest extends RuleTest {
		...
		static final RuleTestType<TinOreFeatureRuleTest> CUSTOM_MATCH = Registry.register(Registry.RULE_TEST,
				new ResourceLocation("avaritia_lp:tin_ore_match"), () -> codec);
