...
public class SilverOreFeature extends OreFeature {
	public static final SilverOreFeature FEATURE = (SilverOreFeature) new SilverOreFeature().setRegistryName("avaritia_lp:silver_ore");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE
			.configured(new OreConfiguration(SilverOreFeatureRuleTest.INSTANCE, AvaritiaLpModBlocks.SILVER_ORE.defaultBlockState(), 7))
	...
	private static class SilverOreFeatureRuleTest extends RuleTest {
		...
		static final RuleTestType<SilverOreFeatureRuleTest> CUSTOM_MATCH = Registry.register(Registry.RULE_TEST,
				new ResourceLocation("avaritia_lp:silver_ore_match"), () -> codec);
