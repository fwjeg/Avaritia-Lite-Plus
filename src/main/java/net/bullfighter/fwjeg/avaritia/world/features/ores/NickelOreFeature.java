...
public class NickelOreFeature extends OreFeature {
	public static final NickelOreFeature FEATURE = (NickelOreFeature) new NickelOreFeature().setRegistryName("avaritia_lp:nickel_ore");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE
			.configured(new OreConfiguration(NickelOreFeatureRuleTest.INSTANCE, AvaritiaLpModBlocks.NICKEL_ORE.defaultBlockState(), 7))
	...
	private static class NickelOreFeatureRuleTest extends RuleTest {
		...
		static final RuleTestType<NickelOreFeatureRuleTest> CUSTOM_MATCH = Registry.register(Registry.RULE_TEST,
				new ResourceLocation("avaritia_lp:nickel_ore_match"), () -> codec);
