...
import net.bullfighter.fwjeg.avaritia.item.TinSingularityItem;
import net.bullfighter.fwjeg.avaritia.item.TinIngotItem;
...
import net.bullfighter.fwjeg.avaritia.item.SingularityzsjItem;
import net.bullfighter.fwjeg.avaritia.item.SingularityxjhjItem;
import net.bullfighter.fwjeg.avaritia.item.SilverSingularityItem;
import net.bullfighter.fwjeg.avaritia.item.SilverIngotItem;
import net.bullfighter.fwjeg.avaritia.item.SilverDustItem;
...
import net.bullfighter.fwjeg.avaritia.item.PlatinumSingularityItem;
import net.bullfighter.fwjeg.avaritia.item.PlatinumDustItem;
import net.bullfighter.fwjeg.avaritia.item.PlanetEaterItem;
import net.bullfighter.fwjeg.avaritia.item.PileofNeutronsItem;
import net.bullfighter.fwjeg.avaritia.item.OrespngItem;
import net.bullfighter.fwjeg.avaritia.item.NickelSingularityItem;
import net.bullfighter.fwjeg.avaritia.item.NickelItem;
...
import net.bullfighter.fwjeg.avaritia.item.LeadSingularityItem;
import net.bullfighter.fwjeg.avaritia.item.LeadIngotItem;
...
import net.bullfighter.fwjeg.avaritia.item.IridiumSingularityItem;
import net.bullfighter.fwjeg.avaritia.item.IridiumItem;
...
import net.bullfighter.fwjeg.avaritia.item.FluxedSingularityItem;
import net.bullfighter.fwjeg.avaritia.item.FluxedIngotItem;
...
public class AvaritiaLpModItems {
	...
	public static final Item TIN_SINGULARITY = register(new TinSingularityItem());
	public static final Item LEAD_SINGULARITY = register(new LeadSingularityItem());
	public static final Item SILVER_SINGULARITY = register(new SilverSingularityItem());
	public static final Item NICKEL_SINGULARITY = register(new NickelSingularityItem());
	public static final Item FLUXED_SINGULARITY = register(new FluxedSingularityItem());
	public static final Item PLATINUM_SINGULARITY = register(new PlatinumSingularityItem());
	public static final Item IRIDIUM_SINGULARITY = register(new IridiumSingularityItem());
	public static final Item SINGULARITYZSJ = register(new SingularityzsjItem());
	public static final Item SINGULARITYXJHJ = register(new SingularityxjhjItem());
	...
	public static final Item FLUXED_INGOT = register(new FluxedIngotItem());
	...
	public static final Item TIN_BLOCK = register(AvaritiaLpModBlocks.TIN_BLOCK, AvaritiaLpModTabs.TAB_ORES);
	public static final Item LEAD_BLOCK = register(AvaritiaLpModBlocks.LEAD_BLOCK, AvaritiaLpModTabs.TAB_ORES);
	public static final Item SILVER_BLOCK = register(AvaritiaLpModBlocks.SILVER_BLOCK, AvaritiaLpModTabs.TAB_ORES);
	public static final Item FLUXED_BLOCK = register(AvaritiaLpModBlocks.FLUXED_BLOCK, AvaritiaLpModTabs.TAB_ORES);
	public static final Item PLATINUM_BLOCK = register(AvaritiaLpModBlocks.PLATINUM_BLOCK, AvaritiaLpModTabs.TAB_ORES);
	public static final Item IRIDIUM_BLOCK = register(AvaritiaLpModBlocks.IRIDIUM_BLOCK, AvaritiaLpModTabs.TAB_ORES);
	public static final Item NICKEL_BLOCK = register(AvaritiaLpModBlocks.NICKEL_BLOCK, AvaritiaLpModTabs.TAB_ORES);
	public static final Item TIN_ORE = register(AvaritiaLpModBlocks.TIN_ORE, AvaritiaLpModTabs.TAB_ORES);
	public static final Item LEAD_ORE = register(AvaritiaLpModBlocks.LEAD_ORE, AvaritiaLpModTabs.TAB_ORES);
	public static final Item SILVER_ORE = register(AvaritiaLpModBlocks.SILVER_ORE, AvaritiaLpModTabs.TAB_ORES);
	public static final Item FLUXED_ORE = register(AvaritiaLpModBlocks.FLUXED_ORE, AvaritiaLpModTabs.TAB_ORES);
	public static final Item PLATINUM_ORE = register(AvaritiaLpModBlocks.PLATINUM_ORE, AvaritiaLpModTabs.TAB_ORES);
	public static final Item IRIDIUM_ORE = register(AvaritiaLpModBlocks.IRIDIUM_ORE, AvaritiaLpModTabs.TAB_ORES);
	public static final Item NICKEL_ORE = register(AvaritiaLpModBlocks.NICKEL_ORE, AvaritiaLpModTabs.TAB_ORES);
	public static final Item ORESPNG = register(new OrespngItem());
