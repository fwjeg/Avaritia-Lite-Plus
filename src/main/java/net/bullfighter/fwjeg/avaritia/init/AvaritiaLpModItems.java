...
public class AvaritiaLpModItems {
	...
	public static final Item TIN_ORE = register(AvaritiaLpModBlocks.TIN_ORE, AvaritiaLpModTabs.TAB_AVARITIATAB);
	public static final Item TIN_BLOCK = register(AvaritiaLpModBlocks.TIN_BLOCK, AvaritiaLpModTabs.TAB_AVARITIATAB);
