...
public class CrossbowOfTheInfernoItem extends Item {
	public CrossbowOfTheInfernoItem() {
		super(new Item.Properties().tab(AvaritiaLpModTabs.TAB_AVARITIATAB).durability(100));
		setRegistryName("crossbow_of_the_inferno");
	}
	...
	public void releaseUsing(ItemStack itemstack, Level world, LivingEntity entityLiving, int timeLeft) {
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				CrossbowOfTheInfernoEntity entityarrow = CrossbowOfTheInfernoEntity.shoot(world, entity, world.getRandom(), 5f, 9999, 5);
