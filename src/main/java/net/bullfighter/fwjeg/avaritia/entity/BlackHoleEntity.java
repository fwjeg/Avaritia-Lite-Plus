...
import net.bullfighter.fwjeg.avaritia.procedures.BlackHoleTickProcedure;
import net.bullfighter.fwjeg.avaritia.procedures.BlackHolePlayerCollidesProcedure;
...
public class BlackHoleEntity extends Monster {
	public BlackHoleEntity(FMLPlayMessages.SpawnEntity packet, Level world) {
		this(AvaritiaLpModEntities.BLACK_HOLE, world);
	}
